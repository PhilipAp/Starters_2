...
public class StarterQ {
	...
	/* 2 Given a string and a non-negative int n, we'll say that the front of the string is the first 3 chars, or whatever is there if the string is less than length 3.
	...
	/* 7 Given a string, return the count of the number of times that a substring length 2 appears in the string and also as the last 2 chars of the string, so "hixxxhi" yields 1 (we won't count the end substring).
			last2("hixxhi") → 1
			last2("xaxxaxaxx") → 1
			last2("axxxaaxx") → 2*/
	...
	/* 14 Suppose the string "yak" is unlucky. Given a string, return a version where all the "yak" are removed, but the "a" can be any char.
	...
	/* 17 Given an array of ints, return true if it contains a 2, 7, 1 pattern: a value, followed by the value plus 5, followed by the value minus 1.
